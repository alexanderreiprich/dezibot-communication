...
void findBotInTheArena() {
  ...
  sendCommand(9, empty, 0, String(fullOnLights[1]));
  sendCommand(9, empty, 0, String(getMaxIndex(fullOnLights, 4)));
  ...
  sendCommand(9, empty, 0, String(startLed + " | " + endLed));
...
void loop() {
  sendCommand(9, empty, 0, "weeeeeee");
  delay(1000);
  // moveForward();
  // delay(1000);
}